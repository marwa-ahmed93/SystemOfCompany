        ...
        <div class="wrapper wrapper--w680">
            <div class="card card-1">
                ...
                <div class="card-body">
                    ...
                    <form action="handlAddTask.php" method="POST" >
...
<?php } ?>              
                        ...
                        <div class="p-t-20">
                        <!-- <a class="btn btn--radius btn--green" href="handlAddTask.php">Add Task</a> -->
                            <button class="btn btn--radius btn--green" type="submit" value="Add">Add Task</button>
                        </div>
                    </form>
                </div>
            </div>

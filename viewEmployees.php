...
$query = " SELECT id , name , email , password , phone , city , gender , birthday , pic
 FROM employees
";
$result = $conn->query($query);
...
<td> <a class="btn btn-danger" href="deletTask.php?task_id=<?php echo $row['task_id'] ?>">Delet</a> <td/>
            </tr>
            <?php
    }
}
